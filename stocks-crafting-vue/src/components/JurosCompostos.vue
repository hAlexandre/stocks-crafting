...
<body>
  ...
  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom" >
    <h3 > <b>Juros Compostos</b></h3>               
  </div>
  <div class="row">
    <div class="col-md-12">
      <p><span style="font-size:15px">J&aacute; pensou em receber dinheiro enquanto <u>dorme</u>? E que tal receber enquanto faz uma <u>viagem </u>com sua fam&iacute;lia ou namorada/namorado? <br>Como isso &eacute; poss&iacute;vel?</span></p>
      <p style="font-size:15px">At&eacute; hoje lembro quando aprendi o que s&atilde;o os <strong>Juros Compostos</strong>! Depois desse dia, a forma como lido com as finan&ccedil;as nunca mais foi a mesma. Aprendi a fazer o dinheiro <strong>trabalhar&nbsp;</strong>para mim ao inv&eacute;s de <strong>trabalhar</strong>&nbsp;para conseguir dinheiro. Mas afinal, o que &eacute; isso?</p>
      <p style="font-size:15px">Os&nbsp;<strong>Juros Compostos </strong>s&atilde;o os rendimentos de aplica&ccedil;&otilde;es financeiras que v&atilde;o se acumulando at&eacute; que <strong>explodem</strong>! Isso mesmo: <strong>explodem.</strong></p>
    </div>
    <!--<div class="col-md-6">
  ...
  <div class="col-md-12">
    <div class="col-md-12">
      ...
      <ul>
        ...
        <li style="font-size:15px">Ao final dos vinte anos, &eacute; poss&iacute;vel ver que a barra dos Juros Compostos cresce muuuuuuuito mais r&aacute;pido do que&nbsp; abarra do total aportado por Beto. </li>
      ...
      <p>Acesse  <b><a href="https://www.amigosdodinheiro.com.br/simuladores">nosso simulador</a></b> para fazer outras simula&ccedil;&otilde;es. L&aacute; detalhamos ano a ano o resultado dos seus investimentos.&nbsp;</p>  
