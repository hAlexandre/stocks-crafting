...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MHGTJ49"
  ...
  <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="#"> <b>Amigos do dinheiro</b></a>
  <button class="navbar-toggler position-absolute d-md-none" type="button" data-toggle="collapse" data-target="#sidebarMenu" aria-controls="sidebarMenu" aria-expanded="true" aria-label="Toggle navigation">
...
<div class="container-fluid">
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse hide" style="opacity:1.0">
      <div class="sidebar-sticky pt-3">
        <ul class="nav flex-column">
          
         <!-- <li class="nav-item">
            <a class="nav-link" href="" data-toggle="collapse" data-target="#sidebarMenu" aria-controls="sidebarMenu" aria-expanded="true" aria-label="Toggle navigation">
          ...
          <!--<li class="nav-item">
            <a class="nav-link" v-bind:class="{active:isSelectedMenu('quemSomos')}" href="" @click="setRoute('quemSomos')" data-toggle="collapse" data-target="#sidebarMenu" aria-controls="sidebarMenu" aria-expanded="true" aria-label="Toggle navigation">
...
export default {
  ...
  methods: {
    ...
    isSelectedMenu(route){
      ...
      console.log(this.selectedMenu == route);
