...
<body>
  ...
  <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="#"> <b>Portal do investidor </b></a>
    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse show">
      <div class="sidebar-sticky pt-3">
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link active" href="" @click="setRoute('/')" data-toggle="collapse" data-target="#sidebarMenu" aria-controls="sidebarMenu" aria-expanded="true" aria-label="Toggle navigation">
          ...
          <li class="nav-item">
            <a class="nav-link" href="" @click="setRoute('Simuladores')" data-toggle="collapse" data-target="#sidebarMenu" aria-controls="sidebarMenu" aria-expanded="true" aria-label="Toggle navigation">
